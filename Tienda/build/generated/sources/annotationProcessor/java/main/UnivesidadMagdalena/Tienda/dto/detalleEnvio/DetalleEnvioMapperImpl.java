...
public class DetalleEnvioMapperImpl implements DetalleEnvioMapper {
    ...
    @Override
    public DetalleEnvioDto detalleEnvioToDetalleEnvioDto(DetalleEnvio detalleEnvio) {
    ...
    @Override
    public DetalleEnvio detalleEnvioDtoToDetalleEnvio(DetalleEnvioDto detalleEnvioDto) {
    ...
    @Override
    public DetalleEnvio detalleEnvioToSaveToDetalleEnvio(DetalleEnvioToSaveDto detalleEnvioToSaveDto) {
        if ( detalleEnvioToSaveDto == null ) {
            return null;
        }

        DetalleEnvio.DetalleEnvioBuilder detalleEnvio = DetalleEnvio.builder();

        detalleEnvio.id( detalleEnvioToSaveDto.id() );
        detalleEnvio.direccion( detalleEnvioToSaveDto.direccion() );
        detalleEnvio.transportadora( detalleEnvioToSaveDto.transportadora() );
        detalleEnvio.numeroGuia( detalleEnvioToSaveDto.numeroGuia() );

        return detalleEnvio.build();
    }

    @Override
    public List<DetalleEnvioDto> detalleEnviosToDetalleEnviosDto(List<DetalleEnvio> detalleEnvioList) {
        if ( detalleEnvioList == null ) {
            return null;
        }

        List<DetalleEnvioDto> list = new ArrayList<DetalleEnvioDto>( detalleEnvioList.size() );
        for ( DetalleEnvio detalleEnvio : detalleEnvioList ) {
            list.add( detalleEnvioToDetalleEnvioDto( detalleEnvio ) );
        }
    ...
    @Override
    public List<DetalleEnvio> detalleEnviosDtoToDetalleEnvios(List<DetalleEnvioDto> detalleEnvioDtoList) {
        if ( detalleEnvioDtoList == null ) {
            return null;
        }

        List<DetalleEnvio> list = new ArrayList<DetalleEnvio>( detalleEnvioDtoList.size() );
        for ( DetalleEnvioDto detalleEnvioDto : detalleEnvioDtoList ) {
            list.add( detalleEnvioDtoToDetalleEnvio( detalleEnvioDto ) );
        }
