...
public class ClienteMapperImpl implements ClienteMapper {
    ...
    @Override
    public Cliente clienteToSaveDtoToCliente(ClienteToSaveDto clienteToSaveDto) {
        ...
        cliente.id( clienteToSaveDto.id() );
        cliente.nombre( clienteToSaveDto.nombre() );
        cliente.email( clienteToSaveDto.email() );
        cliente.direccion( clienteToSaveDto.direccion() );
    ...
    @Override
    public List<ClienteDto> clientesToClientesDto(List<Cliente> clienteList) {
        if ( clienteList == null ) {
            return null;
        }
    ...
    @Override
    public List<Cliente> clientesDtoToClientes(List<ClienteDto> clienteDtoList) {
